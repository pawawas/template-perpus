                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table datatables" id="dataTable-1">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $no = 0;
                                                    $sql = "SELECT buku.*,kategoribuku.* FROM buku, kategoribuku where buku.KategoriID = kategoribuku.KategoriID";
                                                    ...
                                                    ?>
                                                        <tr class="text-center">
                                                            ...
                                                            <th><?php echo $result['Penulis']; ?></th>
                                                            <th><?php echo $result['Penerbit']; ?></th>
                                                            <th><?php echo $result['TahunTerbit']; ?></th>
                                                            <th><?php echo $result['NamaKategori']; ?></th>
                                                            <th><?php echo $result['Stok']; ?></th>
                                                            <th><img src="../foto/<?php echo $result['Gambar'] ?>" width="50" height="75" alt=""></th>
                                                            <th>
                                                                <a href="buku_view.php?id=<?php echo $result['BukuID']; ?>" class="btn btn-primary fe fe-eye"></a>
                                                                <a href="hapus_buku.php?id=<?php echo $result['BukuID']; ?>" class="btn btn-danger fe fe-x-circle" onclick="return confirm('Apakah anda akan menghapus <?php echo $result['Judul']; ?>?');"></a>
                                                                <a href="edit_buku.php?id=<?php echo $result['BukuID']; ?>" class="btn btn-warning fe fe-edit">
                                                                </a>
                                                            </th>
                                                        </tr>
                                                </tbody>
