            ...
            <main role="main" class="main-content">
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <h2 class="mb-2 page-title">Data Petugas</h2>
                            <div class="row my-4">
                                <!-- Small table -->
                                <div class="col-md-12">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            ...
                                            <table class="table datatables" id="dataTable-1">
                                                <thead>
                                                    <a href="tambah_petugas.php" class="btn btn-primary mb-3">Tambah Data</a>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr class="text-center">
                                                            ...
                                                            <th><?php echo $result['NamaLengkap']; ?></th>
                                                            <th><?php echo $result['Alamat']; ?></th>


                                                            <th class="text-center">
                                                                <a href="petugas_view.php?id=<?php echo $result['UserID']; ?>" class="btn btn-primary fe fe-eye"></a>
                                                                <a href="hapus_petugass.php?id=<?php echo $result['UserID']; ?>" class="btn btn-danger fe fe-x-circle" onclick="return confirm('Apakah anda akan menghapus <?php echo $result['Username']; ?>?');"></a>
                                                                <a href="edit_petugas.php?id=<?php echo $result['UserID']; ?>" class="btn btn-warning fe fe-edit">
                                                                </a>
                                                            </th>
                                                        </tr>
                                                </tbody>
