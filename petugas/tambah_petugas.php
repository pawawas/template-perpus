            ...
            <main role="main" class="main-content">
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <h2 class="mb-2 page-title">Tambah Data Petugas</h2>
                            <div class="row my-4">
                                <!-- Small table -->
                                <div class="col-md-12">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                <form action="proses_tambah_petugas.php" method="post">
                                                    ...
                                                    <input type="text" name="nama" class="form-control" id="barang" placeholder="Masukkan Nama Petugas" required>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Passowrd</label>
                                                <input type="text" name="password" class="form-control" id="barang" placeholder="Masukkan Password" required>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Email</label>
                                                <input type="text" name="email" class="form-control" id="barang" placeholder="Masukkan Email" required>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Nama Lengkap</label>
                                                <input type="text" name="namalengkap" class="form-control" id="barang" placeholder="Masukkan Nama Lengkap" required>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Alamat</label>
                                                <textarea name="alamat" class="form-control" id="barang" placeholder="Masukkan Aamat" required></textarea>
                                            </div>
