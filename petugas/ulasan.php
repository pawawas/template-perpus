            ...
            <main role="main" class="main-content">
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <h2 class="mb-2 page-title">Data Ulasan</h2>
                            <div class="row my-4">
                                <!-- Small table -->
                                <div class="col-md-12">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table datatables" id="dataTable-1">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $no = 0;
                                                    $sql = "SELECT ulasanbuku.*,buku.*,kategoribuku.*,user.* FROM ulasanbuku,buku,kategoribuku,user WHERE buku.BukuID=ulasanbuku.BukuID
											AND kategoribuku.KategoriID=buku.KategoriID AND user.UserID=ulasanbuku.UserID ORDER BY UlasanID DESC";
                                                    ...
                                                    ?>
                                                        <tr class="text-center">
                                                            ...
                                                            <th><?php echo $result['Ulasan']; ?></th>
                                                            <th><?php echo $result['Rating']; ?></th>
                                                            <th>
                                                                <a href="hapus_ulasan.php?id=<?php echo $result['UlasanID']; ?>" class="btn btn-danger"><i class="fe fe-x"></i></a>
                                                            </th>
                                                        </tr>
                                                </tbody>
                                            <?php } ?>
