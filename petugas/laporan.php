            ...
            <main role="main" class="main-content">
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <h2 class="mb-2 page-title">Laporan Peminjaman</h2>
                            <div class="row my-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            ?>
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">Laporan Peminjaman Tanggal <?php echo $mulai ?> sampai <?php echo $selesai; ?></div>
                                                ...
                                                <form action="cetak_laporan.php?awal=<?php echo $mulai; ?>&akhir=<?php echo $selesai; ?>&status=<?php echo $status ?>" target="_blank" method="post">
                                                    <div class="form-group">
