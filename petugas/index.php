                                    ...
                                    <div class="card shadow  border-0">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col pr-0">
                                                    <?php
                                                    $query_kategori = mysqli_query($koneksidb, "select * from kategoribuku");
                                                    $result3 = mysqli_num_rows($query_kategori);
                                                    ?>

                                                    <p class="small text-muted mb-0">Data Kategori Buku</p>
