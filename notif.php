        ...
        <section class="cart_area">
            <div class="container">
                <div class="main_title">
                    <h2><span>Notif Buku Yang Siap Diambil </span></h2>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $id_user = $resultt['UserID'];
                                $no = 0;
                                $sql = "SELECT peminjaman.*,buku.*,kategoribuku.*,user.* FROM peminjaman,buku,kategoribuku,user WHERE buku.BukuID=peminjaman.BukuID
											AND kategoribuku.KategoriID=buku.KategoriID AND user.UserID=peminjaman.UserID and StatusPeminjaman ='dipesan' and user.UserID = '$id_user'";
