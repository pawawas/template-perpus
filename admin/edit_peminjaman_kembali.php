                                ...
                                <div class="col-md-12">
                                    <div class="card shadow">
                                        <div class="card-body">
											...
											AND kategoribuku.KategoriID=buku.KategoriID AND user.UserID=peminjaman.UserID AND peminjamanID='$id'";
                                            ...
                                            <div class="mb-3 col-md-6">
                                                <form action="proses_edit_buku.php" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <input type="text" name="nama" class="form-control" id="barang" value="<?php echo $result['Judul'] ?>" disabled>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Email</label>
                                                <input type="text" name="penulis" class="form-control" id="barang" value="<?php echo $result['Email'] ?>" disabled>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">NamaLengkap</label>
                                                <input type="text" name="penerbit" class="form-control" id="barang" value="<?php echo $result['NamaLengkap'] ?>" disabled>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Alamat</label>
                                                <input type="text" name="kategori" class="form-control" id="barang" value="<?php echo $result['Alamat'] ?>" disabled>
                                            </div>
                                            </form>
                                        </div>
                                    </div>
                                                ...
                                                <div class="card-body">
                                                    <form action="proses_kembali.php" method="post">
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <input type="hidden" name="id" class="form-control" id="barang" value="<?php echo $result['peminjamanID'] ?>">
                                                            <input type="hidden" name="idbuku" class="form-control" id="barang" value="<?php echo $result['BukuID'] ?>">
                                                            <input type="text" name="judul" class="form-control" id="barang" value="<?php echo $result['Judul'] ?>" disabled>
                                                        </div>
                                                        <div class="mb-3 col-md-6">
                                                            <label class="form-label">Tanggal Peminjaman</label>
                                                            <input type="text" name="tgl1" class="form-control" id="barang" value="<?php echo $result['TanggalPeminjaman'] ?>" disabled>
                                                        </div>
                                                        <div class="mb-3 col-md-6">
                                                            <label class="form-label">Tanggal Pengembalian</label>
                                                            <input type="text" name="tgl2" class="form-control" id="barang" value="<?php echo $result['TanggalPengembalian'] ?>" disabled>
                                                        </div>
                                                        <div class="mb-3 col-md-6">
                                                            <label class="form-label">Status</label>
                                                            <input type="text" name="status" class="form-control" id="barang" value="<?php echo $result['StatusPeminjaman'] ?>" disabled>
                                                        </div>
                                                        <div class="mb-3 col-md-6">
                                                            <label class="form-label">Jumlah</label>
                                                            <input type="number" name="jumlah" class="form-control" id="barang" value="<?php echo $result['Jumlah'] ?>" disabled>
                                                        </div>
                                                        <div class="mb-3 col-md-6">
                                                            <label class="form-label">Kondisi Pengembalian</label>
                                                            <select class="form-control" name="denda" required>
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            <a href="peminjaman_kembali.php" class="btn btn-warning">Kembali</a>
