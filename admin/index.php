                        ...
                        <ul class="navbar-nav flex-fill w-100 mb-2">
                            ...
                            <li class="nav-item w-100">
                                <a class="nav-link" href="ulasan.php">
                                    ...
                                    <span class="ml-3 item-text">Ulas an</span>
                                </a>
                            </li>
                        </ul>
                                    ...
                                    <div class="card shadow  border-0">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col pr-0">
                                                    <?php
                                                    $query_buku = mysqli_query($koneksidb, "select * from buku");
                                                    $result = mysqli_num_rows($query_buku);
                                                    ?>

                                                    <p class="small text-muted mb-0">Data Buku</p>
                                                    <span class="h3 mb-0"><?php echo $result ?></span>
                                                    <span class="small text-muted">Buku</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card shadow border-0">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col pr-0">
                                                    <?php
                                                    $query_pinjam = mysqli_query($koneksidb, "select * from peminjaman");
                                                    $result1 = mysqli_num_rows($query_pinjam);
                                                    ?>
                                                    <p class="small text-muted mb-0">Data Peminjaman</p>
                                                    <span class="h3 mb-0"><?php echo $result1 ?></span>
                                                    <span class="small text-success">Peminjaman</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card shadow border-0">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col pr-0">
                                                    <?php
                                                    $query_user = mysqli_query($koneksidb, "select * from user where level ='user'");
                                                    $result2 = mysqli_num_rows($query_user);
                                                    ?>
                                                    <p class="small text-muted mb-0">Data User</p>
                                                    <span class="h3 mb-0"><?php echo $result2 ?></span>
                                                    <span class="small text-success">User</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card shadow border-0">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col pr-0">
                                                    <?php
                                                    $query_petugas = mysqli_query($koneksidb, "select * from user where level ='petugas'");
                                                    $result3 = mysqli_num_rows($query_petugas);
                                                    ?>
                                                    <p class="small text-muted mb-0">Data Petugas</p>
                                                    <span class="h3 mb-0"><?php echo $result3 ?></span>
                                                    <span class="small text-success">Petugas</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
