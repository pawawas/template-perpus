                                                    ...
                                                    ?>
                                                        <tr class="text-center">
                                                            ...
                                                            <th class="text-center">
                                                                <a href="user_view.php?id=<?php echo $result['UserID']; ?>" class="btn btn-primary fe fe-eye"></a>
                                                                <a href="hapus_user.php?id=<?php echo $result['UserID']; ?>" class="btn btn-danger fe fe-x-circle" onclick="return confirm('Apakah anda akan menghapus <?php echo $result['Username']; ?>?');"></a>
                                                                <a href="edit_user.php?id=<?php echo $result['UserID']; ?>" class="btn btn-warning fe fe-edit">
                                                                </a>
                                                            </th>
                                                        </tr>
                                                </tbody>
