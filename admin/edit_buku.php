                                            ...
                                            <div class="card-body ">
                                                <div class="mb-3 col-md-6">
                                                    <form action="proses_edit_buku.php" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <input type="text" name="nama" class="form-control" id="barang" value="<?php echo $result['Judul'] ?>">
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label class="form-label">Penulis</label>
                                                    <input type="text" name="penulis" class="form-control" id="barang" value="<?php echo $result['Penulis'] ?>">
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label class="form-label">Penerbit</label>
                                                    <input type="text" name="penerbit" class="form-control" id="barang" value="<?php echo $result['Penerbit'] ?>">
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label class="form-label">Tahun Terbit</label>
                                                    <input type="text" name="tahun" class="form-control" id="barang" value="<?php echo $result['TahunTerbit'] ?>">
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label class="form-label">Nama Kategori</label>
                                                    <input type="hidden" name="idkat" class="form-control" id="barang" value="<?php echo $result['KategoriID'] ?>">
                                                    <input type="text" name="kategori" class="form-control" id="barang" value="<?php echo $result['NamaKategori'] ?>">
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label class="form-label">Gambar Buku</label>
                                                    </br>
                                                    <input type="checkbox" name="ubah" value="true"> Ceklis jika ingin mengubah Gambar<br>
