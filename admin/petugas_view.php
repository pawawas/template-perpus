            ...
            <main role="main" class="main-content">
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <h2 class="mb-2 page-title">Detail Data Petugas</h2>
                            <div class="row my-4">
                                <!-- Small table -->
                                <div class="col-md-12">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                <form action="proses_tambah_user.php" method="post">
                                                    ...
                                                    <input type="text" name="nama" class="form-control" id="barang" value="<?php echo $result['Username'] ?>" disabled>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Email</label>
                                                <input type="text" name="email" class="form-control" id="barang" value="<?php echo $result['Email'] ?>" disabled>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Nama Lengkap</label>
                                                <input type="text" name="namalengkap" class="form-control" id="barang" value="<?php echo $result['NamaLengkap'] ?>"" disabled>
                            </div>
                            <div class=" mb-3 col-md-6">
                                                <label class="form-label">Alamat</label>
                                                <input type="text" name="alamat" class="form-control" id="barang" value="<?php echo $result['Alamat'] ?>" disabled>
                                            </div>
