                                    ...
                                    <div class="card shadow">
                                        <div class="card-body">
                                            ...
                                            <table class="table datatables" id="dataTable-1">
                                                <thead>
                                                    <a href="tambah_admin.php" class="btn btn-primary mb-3">Tambah Data</a>
                                                    ...
                                                    ?>
                                                        <tr class="text-center">
                                                            ...
                                                            <th class="text-center">
                                                                <a href="admin_view.php?id=<?php echo $result['UserID']; ?>" class="btn btn-primary fe fe-eye"></a>
                                                                <a href="hapus_admin.php?id=<?php echo $result['UserID']; ?>" class="btn btn-danger fe fe-x-circle" onclick="return confirm('Apakah anda akan menghapus <?php echo $result['Username']; ?>?');"></a>
                                                                <a href="edit_admin.php?id=<?php echo $result['UserID']; ?>" class="btn btn-warning fe fe-edit">
                                                                </a>
                                                            </th>
                                                        </tr>
                                                </tbody>
