            ...
            <main role="main" class="main-content">
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <h2 class="mb-2 page-title">Data Peminjaman | Dipesan </h2>
                            <div class="row my-4">
                                <!-- Small table -->
                                <div class="col-md-12">
                                    <div class="card shadow">
                                        <div class="card-body">
											...
											AND kategoribuku.KategoriID=buku.KategoriID AND user.UserID=peminjaman.UserID AND StatusPeminjaman='dipesan'";
                                                    ...
                                                    ?>
                                                        <tr class="text-center">
                                                            ...
                                                            <th class="text-center">
                                                                <a href="proses_dipesan.php?id=<?php echo $result['peminjamanID']; ?>" class="btn btn-primary fe fe-click"> DIpesan</a> </a>
                                                            </th>
                                                        </tr>
                                                </tbody>
                                            <?php } ?>
