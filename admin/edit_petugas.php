            ...
            <main role="main" class="main-content">
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <h2 class="mb-2 page-title">Edit Data Petugas</h2>
                            <div class="row my-4">
                                <!-- Small table -->
                                <div class="col-md-12">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="proses_edit_petugas.php" method="post">
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" name="nama" class="form-control" id="barang" value="<?php echo $result['Username'] ?>">
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" name="email" class="form-control" id="barang" value="<?php echo $result['Email'] ?>">
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label class="form-label">Nama Lengkap</label>
                                                    <input type="text" name="namalengkap" class="form-control" id="barang" value="<?php echo $result['NamaLengkap'] ?>">
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label class="form-label">Alamat</label>
                                                    <input type="text" name="alamat" class="form-control" id="barang" value="<?php echo $result['Alamat'] ?>">
                                                </div>
