                            ...
                            <div class="col-md-12">
                                <div class="card shadow">
                                    <div class="card-body">
                                        ...
                                        <?php
                                        $id = $_GET['id'];
                                        $sql = "select kategoribuku.*, buku.* from kategoribuku,buku where buku.KategoriID = kategoribuku.KategoriID AND BukuID = '$id'";
                                        ...
                                        <div class="card-body ">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="text" name="email" class="form-control" id="barang" value="<?php echo $result['Penulis'] ?>" disabled>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Penerbit</label>
                                                <input type="text" name="email" class="form-control" id="barang" value="<?php echo $result['Penerbit'] ?>" disabled>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Tahun Terbit</label>
                                                <input type="text" name="namalengkap" class="form-control" id="barang" value="<?php echo $result['TahunTerbit'] ?>" disabled>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Nama Kategori</label>
                                                <input type="text" name="namalengkap" class="form-control" id="barang" value="<?php echo $result['NamaKategori'] ?>" disabled>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Stok</label>
                                                <input type="text" name="Stok" class="form-control" id="barang" value="<?php echo $result['Stok'] ?>" disabled>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label">Gambar Buku</label>
                                                <img src="../foto/<?php echo $result['Gambar'] ?>" class="card-img-top" width="200" height="600">
                                            </div>
