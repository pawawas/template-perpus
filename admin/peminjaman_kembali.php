                                ...
                                <div class="col-md-12">
                                    <div class="card shadow">
                                        <div class="card-body">
											...
											AND kategoribuku.KategoriID=buku.KategoriID AND user.UserID=peminjaman.UserID AND StatusPeminjaman='dipinjam'";
                                                    ...
                                                    ?>
                                                        <tr class="text-center">
                                                            ...
                                                            <th style="color:red">
                                                                <?php echo $result['StatusPeminjaman']; ?>
                                                            </th>
                                                            <th>
                                                                <a href="edit_peminjaman_kembali.php?id=<?php echo $result['peminjamanID']; ?>"><i class="fe fe-edit"></i></a>
                                                            </th>
                                                        </tr>
                                                </tbody>
                                            <?php } ?>
